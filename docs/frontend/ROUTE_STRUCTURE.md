...
`public/sw.js` and `public/workbox-*.js` are stale service-worker files from the previous PWA setup. Do not commit or depend on them unless a maintained PWA strategy is added later.
