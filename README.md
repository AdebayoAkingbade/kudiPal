...
Edit frontend source in `src/app` and `src/features`, not `.next`. The `.next` folder is generated by Next.js during development/builds and should be treated as disposable output.
